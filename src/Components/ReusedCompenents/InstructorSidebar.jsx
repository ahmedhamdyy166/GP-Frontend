        ...
        <div class="h-full bg-neutral-900">
            ...
            <div class="relative pl-3 overflow-y-scroll">
                <div class="flex flex-col w-full font-medium">
                    ...
                    <div>
                        <span class="select-none flex items-center px-4 py-3 cursor-pointer my-[.4rem] rounded-xl">
                            <Link to={'/Instructor'}className={`flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 hover:text-white ${activeLink === 'Instructor' ? 'text-white' : 'text-muted'}`} onClick={() => handleSetActiveLink('InstructorHome')}>Create Courses</Link>
                        </span>
                    </div>
                    {/* <!-- menu item --> */}
