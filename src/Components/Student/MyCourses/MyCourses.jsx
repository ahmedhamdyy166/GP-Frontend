                    ...
                    <tbody>
                        {currentCourses.map((course, index) => (
                            <tr key={index} className="border-b border-dashed last:border-b-0">
                                ...
                                <span className={`text-center align-baseline inline-flex px-4 py-3 mr-auto  items-center font-semibold text-[.95rem] leading-none rounded-lg ${registrationStatuses[course.courseID] === 0 ? 'text-success bg-success-light' : 'text-warning bg-warning-light'}`}>
